...
export class LandingComponent {
  ...
  buttons = [
    ...
    { name: "Unsere Youtube Playlist", value:"https://music.youtube.com/playlist?list=PL02TqV5xmkLHpmmHVrtZHPXGQ8Fn5E2Um&si=b7KfAeYGvABvozly", ico_url: "../assets/YTMusic.svg", status: "active"},
