...
export class LandingenComponent {
  ...
  buttons = [
    ...
    { name: 'Only German WP Group (Open in March 9th)', value: 'https://docs.google.com/forms/d/e/1FAIpQLSdohsi2XKvEB5yFHi4epYBM9FLE68RxM_CV3rC_etro8SWADw/viewform?usp=sf_link', ico_url: "../assets/wp.svg",status:"active",},
    ...
    { name: "Our Youtube Playlist", value:"https://music.youtube.com/playlist?list=PL02TqV5xmkLHpmmHVrtZHPXGQ8Fn5E2Um&si=b7KfAeYGvABvozly", ico_url: "../assets/YTMusic.svg",status:"active"},
    {name: "Our Spotify Playlist", value: "https://open.spotify.com/playlist/4OOwZqXG8mAMoClVhPZYGo?si=ce12e1fa677c4b97", ico_url: "https://upload.wikimedia.org/wikipedia/commons/8/84/Spotify_icon.svg",status:"active",},
